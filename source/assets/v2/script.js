...
async function main(){
    if(await sendCommand('checkProxy')=='false')await sendCommand('startProxy')
    ...
    document.getElementById('ipmb').innerText=ips
    
    
    // setInterval(()=>cfg.style.height = (cfg.scrollHeight+2) + 'px',1000)
